...
Gtheme treats a desktop theme as a coordinated unit: colors, fonts, wallpaper, WM configuration, bar layout, terminal palette, editor colorscheme. All of it. One command applies all of it.
