...
description: "Gtheme applies a consistent theme across your terminal, status bar, editor, wallpaper, and launcher with a single command. Run gtheme desktop apply <desktop> --theme <theme> (for example, gtheme desktop apply hyprland --theme tokyonight) and the whole desktop repaints in one pass. 350+ themes, any window manager, one invocation."
date: 2026-07-09
author: "David"
...
<DiffCode
  leftTitle="alacritty.toml, hardcoded for Tokyo Night"
